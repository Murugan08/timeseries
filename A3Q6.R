...
rep.kpss(Mergedatafile$gold) #1 level
rep.kpss(Mergedatafile$bitcoin) # 1 level
rep.kpss(Mergedatafile$exchange) # 1 level  
rep.kpss(Mergedatafile$SP500)# 1 level
rep.kpss(Mergedatafile$oil) #1 level
#(7)
